...
import com.google.mediapipe.components.CameraXPreviewHelper2;
import com.google.mediapipe.components.ExternalTextureConverter2;
...
public class CameraInput2 {
  ...
  private final CameraXPreviewHelper2 cameraHelper;
  ...
  public ExternalTextureConverter2 getConverter() {
    return converter;
  }
   ...
   */
  public CameraInput2(Activity activity) {
    cameraHelper = new CameraXPreviewHelper2();
  ...
  public void start(
    ...
    if (converter == null) {
      converter = new ExternalTextureConverter2(eglContext, 2);
    }
