...
import com.google.mediapipe.glutil.ExternalTextureRenderer2;
...
public class ExternalTextureConverter2 implements TextureFrameProducer {
  private static final String TAG = "ExternalTextureConv2"; // Max length of a tag is 23.
  ...
  public ExternalTextureConverter2(
  ...
  protected static class RenderThread extends GlThread
    ...
    public RenderThread(EGLContext parentContext, int numBuffers) {
      ...
      renderer = new ExternalTextureRenderer2();
