 ...
 */
public class CameraXPreviewHelper2 extends CameraHelper {
    /**
    ...
    private static Size TARGET_SIZE = new Size(1920, 1200);
...
//    Log.e("haha",rotatedSize.getWidth()+"");
...
//                frameSize=new Size(request.getResolution().getWidth()/2,request.getResolution().getHeight()/2);
//                Log.e("ss",frameSize.getWidth()+":"+frameSize.getHeight()+"----"+TARGET_SIZE.getWidth()+":"+TARGET_SIZE.getHeight());
////                frameSize=TARGET_SIZE;
                                Log.d(
                                        TAG,
                                        String.format(
     ...
     * method works when {@link CameraXPreviewHelper2#startCamera(Activity, ImageCapture.Builder,
