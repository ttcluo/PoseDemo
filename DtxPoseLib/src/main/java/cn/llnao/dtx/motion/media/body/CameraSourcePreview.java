...
package cn.llnao.dtx.motion.media.body;
...
//    super.onMeasure(MeasureSpec.makeMeasureSpec(320,MeasureSpec.EXACTLY), MeasureSpec.makeMeasureSpec(200,MeasureSpec.EXACTLY));
    }
...
//            }
    ...
    private void startIfReady() throws IOException, SecurityException {
        Log.e(TAG, "start." + surfaceAvailable);
        if (startRequested && surfaceAvailable) {
            ...
            if (overlay != null) {
                ...
                if (isPortraitMode()) {
                    ...
                    Log.e("pppp",min+":"+max+"----"+size.getWidth()+":"+size.getHeight());
    ...
    private class SurfaceCallback implements SurfaceHolder.Callback {
        ...
        public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
            Log.e(TAG, "surfaceChanged" + surfaceAvailable);
        }
    }
